...
public class ChooseOutputFile extends D_PrimFunction {
  ...
  public static Path chooseOutputFile(Obj[] options) {
    ...
    if(osName.equals("Mac OS X")) {
      Path path = main.java.namespace.os.mac.ChooseOutputFile.chooseOutputFile(options);
      return path;
    }
    else
  ...
  public void apply(Evaluator etor, D_List args) {
    Path path = chooseOutputFile(args.asRawArray());
    Obj res = D_Nil.NIL;
    if(path != null)
